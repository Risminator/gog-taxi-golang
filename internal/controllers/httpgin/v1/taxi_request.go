...
func (r *taxiRequestRoutes) createRequest(c *gin.Context) {
	...
	req, err := r.taxiUsecase.CreateRequest(body.TaxiRequestId, body.CustomerId, body.DriverId, body.DepartureId, body.DestinationId, body.DepartureLongitude, body.DepartureLatitude, body.DestinationLongitude, body.DestinationLatitude, body.Price, body.PlannedTime)
	if err != nil {
		c.AbortWithError(http.StatusInternalServerError, err)
		return
	}
